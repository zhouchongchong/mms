    ...
    $.uedWidget('ued.uedSelect', {
        ...
        _createSelect : function($el) {
		   ...
		   if($el.attr("unit")){
			...
			// console.log($el.find('option:selected').text());
			//··添加焦点操作
			$el.focus(function(){
...
(function($) {
    $.uedWidget('ued.uedImg', {
        ...
        _createImg : function ($el) {
            var $el = this.element, options = this.options, self = this;
            $el.on('mouseout', function(event) {
                event.preventDefault();
                $(this).prev('.imgDelete').hide();
            });
            $el.on('mouseenter', function(event) {
                event.preventDefault();
                $(this).prev('.imgDelete').show();
            });
            $el.prev('.imgDelete').on('mouseenter', function(event) {
                event.preventDefault();
                $(this).show();
            });
            $el.prev('.imgDelete').on('mouseout', function(event) {
                event.preventDefault();
                $(this).hide();
            });
            $el.prev('.imgDelete').on('click', function(event) {
                event.preventDefault();
