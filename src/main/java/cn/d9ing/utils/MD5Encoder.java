/**  
 * Project Name:mms  
 * File Name:MD5Encoder.java  
 * Package Name:cn.d9ing.utils  
 * Date:2017年5月18日下午9:11:44  
...
/**  
 * ClassName:MD5Encoder <br/>  
 * Function: TODO ADD FUNCTION. <br/>  
 * Reason:   TODO ADD REASON. <br/>  
 * Date:     2017年5月18日 下午9:11:44 <br/>  
 * @author   zhouchong  
 * @version    
 * @since    JDK 1.8  
 * @see        
...
public class MD5Encoder {
     ...
     * @throws UnsupportedEncodingException
     */
    public static Map<String, String> getEncryptedPwd(String password)
            throws NoSuchAlgorithmException, UnsupportedEncodingException {
        ...
        resultmap.put(byteToHexString(salt), byteToHexString(pwd));
        return resultmap;
    }
